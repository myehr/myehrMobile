<template>
  <div>
    ...
    <div class="swaperBox">
      <text-swiper v-if="datatable[0].childrens" :swipers='datatable[0].childrens[selectedChild].childrens'></text-swiper>
    </div>
    <!-- 添加多tab 列表块 -->
...
activated(){
  ...
  data () {
    return {
      tabList:[{title:'测试页面',path:'/components/tableList/warpBox',icon:''},{title:'我的待办',path:'/myehrpath/testList1Component',icon:''},{title:'我的已办',path:'/myehrpath/testList2Component',icon:''}],
      currentIndex:0,
      version,
      vueVersion,
      undototal:0,
