...
<script>
import { Cell, Group, Badge, Divider,Swiper,SwiperItem,Tab, TabItem,Grid, GridItem,WarpBox} from 'vux'
...
activated(){
  ...
  data () {
    return {
      tabList:[{title:'测试页面',path:'/myehrpath/tableList/warpBox',icon:''},{title:'我的待办',path:'/myehrpath/testList1Component',icon:''},{title:'我的已办',path:'/myehrpath/testList2Component',icon:''}],
      currentIndex:0,
      version,
      vueVersion,
      undototal:0,
