<template>
  <div>
    ...
    <group title="用户" style="margin-top:20px;background:#fff;">
...
activated(){
  ...
  data () {
    return {
      tabList:[{title:'我的待办',path:'/myehrpath/myJobDone',icon:''},{title:'我的已办',path:'/myehrpath/testList2Component',icon:''},{title:'我的已办2',path:'/myehrpath/myJobHaveDone',icon:''}],
      currentIndex:0,
      version,
      vueVersion,
      undototal:0,
