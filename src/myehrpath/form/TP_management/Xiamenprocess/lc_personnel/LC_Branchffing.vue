<template>
  <div >
     <list1-component v-bind:rows="this.rows"   v-bind:standDataColumn="standDataColumn" v-bind:pager="pager" v-bind:showRowDataColumn="showRowColumn" v-bind:right_buttons="right_buttons"
                      ...
                      :orderByColumn="orderByColumn" :isShowTopQuery="isShowTopQuery"  :filterColumnDatas="filterColumnDatas"
...
<script>
    ...
    export default {
      ...
      data () {
        ...
        showRowColumn: [
                        {columnId: 'PERSONNELASSIGNMENT_EMPID_DICTNAME', columnName: '姓名'},
                        {columnId: 'PERSONNELASSIGNMENT_XDEPID_DICTNAME', columnName: '现属支行/部门'},
                        {columnId: 'PERSONNELASSIGNMENT_JOBID_DICTNAME', columnName: '现岗位'},
