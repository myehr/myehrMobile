  ...
  export default {
      ...
      loadData(initRows,pager,filterParams,orderByParam){
       ...
       /* filterParams= { //查询条件实例
        ...
        this.$axios.post('/myehr/form/cardformInitData.action',
          {"order":"asc","offset":0,"limit":10,"containerParam":{},"paramsMap":{},"requestParam":{USERID: "18971"},"filter":{},"formId":"4260","isView":null,"heightGrade":[]}
        )
    ...
    data () {
      return {
        orderByColumn:[],
        isHowTopQuery:false,
        filterColumnDatas:[ { name:'ATTENDCARDIMPORT_AC_CHECKTIME', lableName:'刷卡时间', type:'textbox', dictId:'test', defaultValue:'' }],
