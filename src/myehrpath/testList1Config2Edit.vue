  ...
  <div >
    <group title="分组1">
      ...
      <hr-text-box :title="dataColumn[2].columnName" @onValidChange="onValidChange" v-model="formData[dataColumn[2].columnId]"
                   :is-type="getTextBolxCheck(2)" :required="dataColumn[2].formColumnRequired"
                   :readonly="dataColumn[2].formColumnShowType === 'readonly'?true:false" :placeholder="dataColumn[2].columnTypeDetail.textboxEmptytext"></hr-text-box>
      ...
      <hr-text-box :title="dataColumn[4].columnName" @onValidChange="onValidChange" v-model="formData[dataColumn[4].columnId]"
                   :is-type="getTextBolxCheck(4)" :required="dataColumn[4].formColumnRequired"
                   :readonly="dataColumn[4].formColumnShowType === 'readonly'?true:false" :placeholder="dataColumn[4].columnTypeDetail.textboxEmptytext"></hr-text-box>
